...
import { Search, Book, BookOpen, ChevronDown } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-primary/10 to-secondary/10 py-10">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-primary to-secondary text-white shadow-lg">
        <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 text-center">
          <BookOpen className="mx-auto mb-4 w-10 h-10" />
          <h1 className="text-4xl font-bold tracking-tight">Kafi Explorer</h1>
        </div>
      </div>
        ...
        <div className="card mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none w-full bg-gray-50 border border-gray-300 rounded-lg py-3 px-4 pr-8 text-gray-800 focus:outline-none focus:ring-4 focus:ring-primary/50 focus:border-transparent transition"
                >
                  {[...Array(8).keys()].map((v) => (
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-300 rounded-lg py-3 px-4 pl-10 text-gray-800 focus:outline-none focus:ring-4 focus:ring-primary/50 focus:border-transparent transition"
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              className="inline-flex items-center px-6 py-3 text-base font-medium rounded-lg bg-primary hover:bg-secondary focus:outline-none focus:ring-4 focus:ring-primary/50 text-white transition"
            >
                ...
                <div key={idx} className="card">
                  ...
                  <div className="flex flex-wrap items-center gap-4">
                    <a
                      ...
                      className="text-lg inline-flex items-center text-primary hover:text-secondary transition-colors"
                    >
                      View Source →
                    </a>
