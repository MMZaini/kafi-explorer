...
export default function Home() {
  ...
  const [headingGradientPos, setHeadingGradientPos] = useState({ x: 50, y: 50 });
  const [buttonGradientPos, setButtonGradientPos] = useState({ x: 50, y: 50 });
      ...
      <div className="bg-white/80 backdrop-blur-md shadow-xl select-none">
        <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
          <h1
            ...
            onMouseLeave={() => resetGradient(setHeadingGradientPos)}
          >
            Kafi Explorer
          </h1>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 mb-10">
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              onMouseLeave={() => resetGradient(setButtonGradientPos)}
            >
